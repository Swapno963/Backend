...
from .serializers import ServiceLocationSerializer, FavouriteSerializer, CardSerializer, MenuSerializer
from .models import ServiceLocation, Favourite, Card, Menu
